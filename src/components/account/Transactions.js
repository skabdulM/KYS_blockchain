    ...
    return (
      ...
      <div className="row">
        ...
        <thead className="thead">
          <tr>
          <th className=" col-sm-1 no theader">Number</th>
          <th className=" col-sm-7 no1 theader">Transaction Hash</th>
          <th className=" col-sm-2 no1 theader">Gas Used</th>
          <th className=" col-sm-2 no1 theader">Gas Limit</th>
          </tr> 
          </thead>
          </table>
          </div>
