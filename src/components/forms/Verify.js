...
export default class Verify extends Component {
  ...
  render() {
    ...
    if(this.props.user.loading)
      return (<Loader/>);
    return (
      <div className='verifydcontainer'>         
            <h1 className="custom-h1"> Verify Document </h1>
        <hr/>
        <div className='form-group row padding-40'>
          <div className='col-6'>
            <div className='row'>
              ...
              <div className='col-8'>
                <select name='account' className='inputab' onChange={this.onChange} defaultValue={this.state.account}>
          ...
          <div className='col-10'>
            <div className='row'>
              ...
              <div className='col-8'>
                <input className='input' name='document' type='text' onChange={this.onChange} defaultValue={this.state.document}/>
        ...
        {this.state.submitted && this.props.documents.document.valid && (
          <div className='row'>
            <div className='col-12'>
              ...
              <span className="custom-h1"> <br></br>Name&nbsp;&nbsp;&nbsp; </span>
              <span>
