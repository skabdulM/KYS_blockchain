        ...
        <div className='form-group row padding-40'>
          <div className='col-6'>
            <div className='row'>
              ...
              <div className='col-8'>
                <input className='profileinput' name='name' type='text' onChange={this.onChange} defaultValue={this.state.name}/>
          ...
          <div className='col-6'>
            <div className='row'>
              ...
              <div className='col-8'>
                <input className='profileinput' name='description' type='text' onChange={this.onChange} defaultValue={this.state.description}/>
          ...
          <div className='col-6 padding-top-15'>
            <div className='row'>
              <label htmlFor='select' className='col-4 custom-acc'>Verifier</label>
              <div className='col-8'>
                <select name='verifier' className='input2' onChange={this.onChange} defaultValue={this.state.type}>
          ...
          <div className='col-6 padding-top-15'>
            <div className='row'>
              <label htmlFor='select' className='col-4 custom-acc'>Document</label>
              <div className='col-8'>
          ...
          <div className='col-6 padding-top-15'>
            <div className='row'>
              <label htmlFor='select' className='col-4 custom-acc'>Rate <span className='unit'>(wei)</span></label>
              <div className='col-8'>
                <input className='profileinput' name='rate' type='number' readOnly={true} value={this.state.rate}/>
              </div>
            </div>
          </div>
        </div>
        <div className='float-right '>
          <button type="button" className="btn-verify  " onClick={this.onSubmit}>Submit</button>
          <button type="button" className="btn-verify btns" onClick={this.back}>Back</button>
        </div>
